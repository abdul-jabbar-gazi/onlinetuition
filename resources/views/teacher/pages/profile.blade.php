        ...
        <center>
          ...
          <select name="gender">
            ...
            <option>Other</option>
					...
					<input class="text" type="number" name="salary" placeholder="Wanted Salary" required=""><br>
					<input class="text" type="text" name="skill" placeholder="Your Skill" required=""><br>
